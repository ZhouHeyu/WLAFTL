...
static struct lp_mod disksim_synthgen_mod = { "disksim_synthgen", disksim_synthgen_params, DISKSIM_SYNTHGEN_MAX, (lp_modloader_t)disksim_synthgen_loadparams,  0,0 };
