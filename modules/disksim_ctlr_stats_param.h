...
static struct lp_mod disksim_ctlr_stats_mod = { "disksim_ctlr_stats", disksim_ctlr_stats_params, DISKSIM_CTLR_STATS_MAX, (lp_modloader_t)disksim_ctlr_stats_loadparams,  0,0 };
