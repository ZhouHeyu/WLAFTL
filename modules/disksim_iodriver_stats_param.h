...
static struct lp_mod disksim_iodriver_stats_mod = { "disksim_iodriver_stats", disksim_iodriver_stats_params, DISKSIM_IODRIVER_STATS_MAX, (lp_modloader_t)disksim_iodriver_stats_loadparams,  0,0 };
