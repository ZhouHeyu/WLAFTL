...
static struct lp_mod disksim_cachemem_mod = { "disksim_cachemem", disksim_cachemem_params, DISKSIM_CACHEMEM_MAX, (lp_modloader_t)disksim_cachemem_loadparams,  0,0 };
