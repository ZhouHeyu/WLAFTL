...
/* prototype for disksim_ioqueue param loader function */
   struct ioqueue *disksim_ioqueue_loadparams(struct lp_block *b, int printqueuestats, int printcritstats, int printidlestats, int printintarrstats, int printsizestats);
...
static struct lp_mod disksim_ioqueue_mod = { "disksim_ioqueue", disksim_ioqueue_params, DISKSIM_IOQUEUE_MAX, (lp_modloader_t)disksim_ioqueue_loadparams,  0,0 };
