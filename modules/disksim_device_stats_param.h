...
static struct lp_mod disksim_device_stats_mod = { "disksim_device_stats", disksim_device_stats_params, DISKSIM_DEVICE_STATS_MAX, (lp_modloader_t)disksim_device_stats_loadparams,  0,0 };
